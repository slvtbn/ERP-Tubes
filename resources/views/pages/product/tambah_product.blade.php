...
@section('content')
    ...
    <section class="content">
      <div class="card">
        ...
        <div class="card-body">
          <form role="form" action="{{ url('/product/upload') }}" method="post">
            {{csrf_field()}} 
            <div class="form-group">
                <label for="id_product">Id Product</label>
                <input type="text" class="form-control" id="id_product" placeholder="Masukkan Id Product" name="id_product" autocomplete="off">
             ...
             <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_product" placeholder="Masukkan Nama Product" name="nama_product" autocomplete="off">
