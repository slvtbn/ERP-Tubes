...
@section('content')
    ...
    <section class="content">
      <div class="card">
        ...
        <div class="card-body">
          <form role="form" action="{{ url('/harga_komponen/upload') }}" method="post">
            {{csrf_field()}} 
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jumlah" placeholder="Masukkan Jumlah" name="jumlah" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="harga" placeholder="Masukkan Harga" name="harga" autocomplete="off" readonly>
                @if($errors->has('harga'))
                <span class="text-danger">
