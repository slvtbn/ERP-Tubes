...
@section('content')
    ...
    <section class="content">
      <div class="card">
        ...
        <div class="card-body">
          <form role="form" action="{{ url('/order/update/'.$order->id_order) }}" method="post">
            {{csrf_field()}} 
            {{ method_field('PUT') }}
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="alamat" placeholder="Masukkan Alamat" name="alamat" autocomplete="off" value="{{ $order->alamat }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="telepon" placeholder="Masukkan No Telp" name="telepon" autocomplete="off" value="{{ $order->telepon }}">
            ...
            <div class="form-group">
                ...
                @foreach($product as $p)
                    <option 
                        value="{{$p->id_product}}"
                        @if ($p->id_product === $order->id_product)
                            selected
                        @endif
                    > 
                    {{$p->nama_product}}
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jumlah_produk" placeholder="Masukkan Jumlah" name="jumlah_produk" autocomplete="off" value="{{ $order->jumlah_produk }}">
